        ...
        <div className="min-h-screen bg-background relative flex items-center justify-center p-4 overflow-hidden">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none flex items-center justify-center">
                <motion.div
                    ...
                    className="absolute top-[5%] left-[10%] w-[35rem] h-[35rem] bg-purple-600/30 dark:bg-purple-600/20 rounded-[40%_60%_70%_30%] blur-[100px]"
                />
                <motion.div
                    animate={{
                        x: [0, -250, 150, -100, 0],
                    ...
                    className="absolute bottom-[5%] right-[10%] w-[40rem] h-[40rem] bg-indigo-600/30 dark:bg-indigo-600/20 rounded-[60%_40%_30%_70%] blur-[120px]"
                />
                <motion.div
                    animate={{
                        x: [0, 150, -200, 100, 0],
                    ...
                    className="absolute top-[30%] left-[30%] w-[25rem] h-[25rem] bg-blue-500/25 dark:bg-blue-500/15 rounded-full blur-[90px]"
                />
                <motion.div
                    animate={{
                        x: [0, -100, 200, -150, 0],
                    ...
                    className="absolute bottom-[20%] left-[20%] w-[30rem] h-[30rem] bg-emerald-500/20 dark:bg-emerald-500/10 rounded-[50%_50%_40%_60%] blur-[110px]"
                />
                <motion.div
                    animate={{
                        x: [0, 300, -300, 0],
                    ...
                    className="absolute top-[40%] right-[30%] w-[45rem] h-[45rem] bg-fuchsia-600/20 dark:bg-fuchsia-600/10 rounded-full blur-[140px]"
                />
            </div>
